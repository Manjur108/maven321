...
import web-app.reader.mycomponent.MyStreamReaderImpl
import web-app.transformer.mycomponent.MyStreamTransformerImpl
import web-app.writer.mycomponent.MyStreamWriterImpl
